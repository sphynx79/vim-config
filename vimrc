...
"  General {
 ...
 "  Stratup Vim-Plug {
    ...
    call plug#begin($HOME.'/vimfiles/plugged')
        ...
        Plug 'prettier/vim-prettier', { 'do': 'yarn install', 'branch': 'release/1.x', 'for': ['javascript', 'typescript', 'css', 'less', 'scss', 'json', 'graphql', 'markdown', 'vue'] }
 ...
 "  Environment {
     ...
     if WINDOWS()
         ...
         " let $PATH = 'C:\Program Files\Python36;' . $PATH
         let $PATH = 'C:\RubyVim\bin;' . $PATH
 ...
 "  Color {
      " autocmd ColorScheme * 
      "   \   highlight  Folded guibg=#233844  guifg=#CBDADD
      "   \ | highlight  CursorLine   guibg=#556473  guifg=NONE
      "   \ | highlight  FoldColumn   guibg=#233844  guifg=#CBDADD
      "   \ | highlight  VertSplit    guibg=NONE     guifg=#4A5764
      "   \ | highlight  Search       guibg=#D36145  guifg=white
      "   \ | highlight  MatchParen   guibg=#233844  guifg=NONE
      autocmd ColorScheme * 
        \   highlight  Folded guibg=#1C2328  guifg=#515F66
        \ | highlight  VertSplit guibg=#20272D guifg=NONE
...
"  Ruby & Rails {
    ...
    """""""""""""""""""""""""""""""""""""""""PARAMETRI""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    " setto il path di ruby
    if WINDOWS()
       "let g:ruby_path = ':C:\Ruby-23-vim\bin'
    elseif OSX()
...
"  AutoFormat {
    ...
    " let g:formatters_javascript = ['prettier_javascript', 'ESlint']
    let g:formatdef_pretti_json = '"prettier"'
    let g:formatters_json = ['pretti_json', 'fixjson']
    " let g:formatdef_rufo_ruby = '"rufo "'
    " let g:formatters_ruby = ['rufo_ruby']
    """""""""""""""""""""""""""""""""""""""""SHORTCUT"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    noremap <F9> :silent Autoformat<CR>
    autocmd FileType ruby map <buffer> <F9> :%!rufo<cr>
    autocmd FileType javascript,typescript,css,less,scss,json,graphql,markdown,vue  map <buffer> <F9> :PrettierAsync<CR>
" }AutoFormat
...
"  NerdTree {
    ...
    au FileType nerdtree :vert resize 34
" }NerdTree
...
"     " integrazione con Youcompleteme
    ...
    if WINDOWS()
        let g:UltiSnipsSnippetsDir=$VIM."/vimfiles/plugged/ultisnips/UltiSnips"
    endif
...
"  Autocmd {
   ...
   augroup vimrcEx
        ...
        au BufWritePost vimrc source $VIM/vimrc | AirlineRefresh
        ...
        autocmd Bufwritepre,filewritepre,FocusLost *.rb,*.rbw,*.css,*.js,*.scss,*.ru,*.json  silent call  Autosave()
        autocmd VimLeave  *.rb,*.rbw,*.css,*.js,*.scss,*.ru,*.json :bufdo call Autosave()
